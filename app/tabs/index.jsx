  ...
  return (
    ...
    >
        ...
        <View style={styles.separatorContainer}>
            <View style={[styles.separatorLine, { backgroundColor: theme.colors.border }]} /> {/* left line*/}
                <Text style={[styles.separatorText, { color: theme.colors.text }]}>
                    Exercises
                </Text>
            <View style={[styles.separatorLine, { backgroundColor: theme.colors.border }]} /> {/* right line*/}
        </View>
